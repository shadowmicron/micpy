...
try:
	ser = requests.get("https://pastebin.com/BtimPH2T").text.strip() #Jangan DiEdit Kpnetod
	expx = requests.get("https://pastebin.com/BtimPH2T").text.strip() #Jangan DiEdit Kpnetod
	if waktu >= expx:
		logo_exp()
		sys.exit()
	try:
...
def pilih_pw():
	...
	print(C+"["+K+"2"+C+"]"+K+" 17pass/Bangladesh")
