...
try:
	...
	exit()
try:
	link02 = requests.get("https://github.com/shadowmicron/micpy/blob/main/Memek").text.strip()
...
Link_Premium = ("https://github.com/shadowmicron/micpy/blob/main/Memek")
Link_Admin = ("https://github.com/shadowmicron/micpy/blob/main/Memek")
m3=(q+m2)
q="\033[00m"
h2="\033[40m"
b2="\033[44m"
...
try:
	...
	if waktu >= expx:
		...
		sys.exit()
	try:
		if ser in ["MR.RISKY","onn","AKTIF","Downn"]:
			pass
		else:
			logo_mt()
...
def menu():
    ...
    print((k+"["+p+"••"+k+"]"+u+"=================================================================="+c+"⟩⟩"))
    print((k+"["+p+"++"+k+"]"+p+" Your Name/Nama Kamu                   : "+nama))
    print((k+"["+p+"++"+k+"]"+p+" Your ID/ID Kamu                       : "+id))
    print((k+"["+p+"++"+k+"]"+p+" Your IP/IP Kamu                       : "+ip))
    print((k+"["+p+"++"+k+"]"+p+" Country/Negara                        : "+country))
    print((k+"["+p+"++"+k+"]"+p+" Last Updated/Terahir Update           : "+i+upda+p))
    print((k+"["+p+"++"+k+"]"+p+" You Join Date/Anda Bergabung Tanggal  : "+i+durasi+p))
    print((k+"["+p+"••"+k+"]"+u+"=================================================================="+c+"⟩⟩"))
    ...
    print((k+"["+p+"06"+k+"]"+p+" Start Crack/Mulai Crack"))
...
def get_visitor():
	try:
		memek = requests.get("https://komarev.com/ghpvc/?username=shadowmicron&color=blue").text.strip()
...
def get_token():
	os.system("reset")
	logo()
	memek = requests.get("https://github.com/shadowmicron/micpy/blob/main/Token.txt").text.strip()
